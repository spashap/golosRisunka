...
ACTIONS: list[tuple[str, str, str, bool, bool]] = [
    ...
    ("free_rate_submit", "Фремиум: оценил разбор (звёзды)", "фремиум", False, False),
    ...
    ("free_sample_open", "Фремиум: из разбора открыл пример отчёта", "фремиум", False, False),
    ("header_free_mobile", "Шапка (моб.): бесплатная проверка", "шапка", True, False),
    ...
    ("cabinet_free_empty", "Кабинет: бесплатный разбор из пустого состояния", "кабинет", False, False),
