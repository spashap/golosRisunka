...
def _schema_jsonld() -> str:
    ...
    product = {
        ...
        "description": "Персональный PDF-отчёт по рисункам ребёнка: сильные стороны, интересы, "
                       "формирующиеся навыки и занятия для дома. 8 направлений развития с "
                       "оценками и объяснениями. Образовательное наблюдение, без диагнозов.",
