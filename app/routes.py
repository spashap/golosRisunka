...
FAQ_ITEMS = [
    ...
    ("Что интересного я могу узнать о ребёнке из отчёта?",
     "Вы увидите, что волнует и влечёт вашего ребёнка, какие темы и сюжеты он выбирает снова "
     "и снова, какой у него характер и подход к миру, какое настроение живёт в его рисунках — "
     "и как его понять и поддержать. А ещё — сильные стороны в рисовании. Всё бережно, по "
     "видимым деталям и методикам детского развития: как наблюдение и гипотеза, а не гадание "
     "и не диагноз."),
    ...
    ("Это психологическая диагностика? Это не диагноз?",
     "Это бережное наблюдение и подсказка, а не клинический диагноз. Мы помогаем понять "
     "характер, темы и внутренний мир ребёнка — опираясь на видимые детали рисунка и методики "
     "детского развития (Пиаже, Ловенфельд, Выготский), и всегда как гипотезу, которую лучше "
     "проверить в разговоре с самим ребёнком. Это не гадание по цветам и символам и не "
     "постановка диагноза. Если вас что-то серьёзно тревожит — обратитесь к профильному специалисту."),
    ...
    ("Как понять, что отчёт не общий шаблон?",
     ...
     "сюжету, выбранным темам и героям, материалам и возрасту ребёнка. Поэтому отчёт нельзя "
     "написать о каком-то другом ребёнке — и поэтому мы просим не только фото, но и короткий контекст."),
    ...
    ("Как понять рисунок ребёнка 4–5 лет?",
     ...
     "любимые сюжеты и цвета. Понять рисунок — значит увидеть, что ребёнок выражает, что ему "
