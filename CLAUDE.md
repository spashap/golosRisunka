...
- **ПОСАДОЧНАЯ `/free-check` (холодный платный трафик Meta/Instagram)**: `templates/free_check.html`,
  ...
  заказчика). Карточки тревог — deep-link `/free/?concern=<key>#name`: `free.js` принимает ключ,
  только если такой вариант есть в мастере, и пропускает экран выбора. Шапка на этой странице
